...
BOOL IsLeftButtuonDown = FALSE;
BOOL IsRightButtuonDown = FALSE;
void    ImGui_ImplWin32_NewFrame()
{
    ...
    if (GetAsyncKeyState(VK_LBUTTON) & 0x8000)
    {
        ...
        IsLeftButtuonDown = true;
    }
    else if (IsLeftButtuonDown)
    {
    ...
    if (GetAsyncKeyState(VK_RBUTTON) & 0x8000)
    {
        ...
        IsRightButtuonDown = true;
    }
    else if (IsRightButtuonDown)
    {
